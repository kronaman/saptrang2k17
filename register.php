...
$query1="INSERT INTO `saptrangnitd_user`(`id`, `user_id`, `name`, `age`, `phone`, `email`, `college`, `city`,`acm`) VALUES ('','$random','$name','$age','$phone','$email','$college','$city','$acm')";
...
window.location.assign("http://www.saptrangnitd.com");
</script>
</body>
</html>
